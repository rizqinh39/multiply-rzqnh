...
import com.example.assessmentwecan.ui.App
...
abstract class BaseFragment : Fragment() {
    ...
    protected fun removeFragment(addedToStack: Boolean, fragment: Fragment, fragmentTag: String) {
        if (addedToStack) {
            fragmentManager!!.beginTransaction().remove(fragment).addToBackStack(fragmentTag).commit()
        } else {
